...
class DBHelper {
  ...
  static imageUrlForRestaurant(restaurant) {
    const imageID = restaurant.photograph.length < 6
    ...
    return {
      ...
      smallJPEG1x: `${imagePath}-sm_1x.jpg`,
      smallWEBP2x: `${imagePath}-sm_2x.webp`,
      smallJPEG2x: `${imagePath}-sm_2x.jpg`,
      largeWEBP1x: `${imagePath}-lg_1x.webp`,
      largeJPEG1x: `${imagePath}-lg_1x.jpg`,
      largeWEBP2x: `${imagePath}-lg_2x.webp`,
      largeJPEG2x: `${imagePath}-lg_2x.jpg`,
